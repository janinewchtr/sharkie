...
/**
 * Plays the complete long-idle animation and then repeats its sleeping frames.
 */
playLongIdleAnimation() {
  let path = this.IMAGES_LONG_IDLE[this.longIdleImageIndex];
  this.img = this.imageCache[path];
  this.longIdleImageIndex++;

  if (this.longIdleImageIndex >= this.IMAGES_LONG_IDLE.length) {
    this.longIdleImageIndex = 10;
  }
}
