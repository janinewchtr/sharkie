...
class Collisions {
  ...
  /**
   * Adds poison, updates its status bar and plays the collection sound.
   */
  collectPoison() {
    ...
    audioManager.playPoisonCollectSound();
  }
  ...
  /**
   * Adds a coin, updates its status bar and plays the collection sound.
   */
  collectCoin() {
